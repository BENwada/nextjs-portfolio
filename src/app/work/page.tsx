...
import "swiper/css";
import type { Swiper as swipeIndex } from "swiper";
...
const projects = [
  {
    ...
    title: "project 1",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean id porta nulla.",
...
const Work = () => {
  ...
  const handleSlideChange = (swiper: swipeIndex) => {
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-accent hover:bg-accent-foreground text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
                iconStyles=""
              />
            </Swiper>
          </div>
